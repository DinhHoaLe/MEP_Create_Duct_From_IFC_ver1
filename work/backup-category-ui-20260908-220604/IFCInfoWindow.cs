...
namespace IFCInfo
{
    ...
    public sealed class IFCInfoWindow : Window
    {
            ...
            string instanceId, string source, string note, bool found)
        {
            ...
            var heading = Text("Thông tin IFC link", 26, "#FFFFFF");
            heading.FontWeight = FontWeights.SemiBold;
            heading.Margin = new Thickness(0, 5, 0, 5);
            headerStack.Children.Add(heading);
            var subtitle = Text("Bước 1 / 2 · Thông tin nguồn của link vừa chọn", 13, "#C3D2E2");
            ...
            feedback = Text("Chọn văn bản để sao chép, hoặc dùng các nút bên dưới.", 12, "#60738A");
            ...
            copyAll.Click += (s, e) => Copy("Tên file IFC: " + fileName + "\nIFC: " + ifcPath +
                ...
                "\nNguồn: " + source + "\n" + note +
                (onCountPage ? "\nAir Terminals: " + (AirTerminalCount.HasValue
                    ? AirTerminalCount.Value.ToString() : "Không có kết quả") +
                    "\nPhạm vi: toàn bộ model link vừa chọn; category Air Terminals, không tính element types hoặc nested links." +
                    "\n" + AirTerminalError + "\n" + IfcSourceStatus +
            ...
            var next = Button("Next →", true);
            buttons.Children.Add(next);
            next.Click += (s, e) =>
            {
                onCountPage = true;
                heading.Text = "Số lượng Air Terminals";
            ...
            {
                onCountPage = false;
                heading.Text = "Thông tin IFC link";
                subtitle.Text = "Bước 1 / 2 · Thông tin nguồn của link vừa chọn";
                scroll.Content = body;
                scroll.ScrollToTop();
                next.Visibility = Visibility.Visible;
                back.Visibility = Visibility.Collapsed;
                copyName.Visibility = Visibility.Visible;
                feedback.Text = "Chọn Next để xem số lượng Air Terminals.";
                feedback.Foreground = Brush("#60738A");
            };
            ...
            next.Click += (s, e) => replace.Visibility = Visibility.Visible;
        ...
        private FrameworkElement CountPage(string fileName, string instanceId)
        {
            ...
            stack.Children.Add(Text("AIR TERMINALS", 12, "#60738A"));
            ...
            foreach (var column in new[] {
                ...
                new { Header = "Air Terminal", Property = "Name", Width = 220.0 },
                new { Header = "System Type / IFC", Property = "SystemType", Width = 150.0 },
            ...
            var details = Text("Đếm phần tử thuộc category Air Terminals trên toàn bộ model link vừa chọn. " +
        ...
        {
            var result = new StringBuilder("Element ID\tAir Terminal\tSystem Type / IFC\tSystem Name\tZ IFC (mm)\tNguồn dữ liệu\tIFC GUID");
