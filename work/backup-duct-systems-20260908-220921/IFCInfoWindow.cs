...
namespace IFCInfo
{
    ...
    public sealed class IFCInfoWindow : Window
    {
            ...
            string instanceId, string source, string note, bool found)
        {
            ...
            var subtitle = Text("Bước 1 / 2 · Chọn Category trong IFC link để tiếp tục", 13, "#C3D2E2");
            ...
            back.Click += (s, e) =>
            {
                ...
                subtitle.Text = "Bước 1 / 2 · Chọn Category trong IFC link để tiếp tục";
                scroll.Content = body;
                scroll.ScrollToTop();
        ...
        {
            var result = new StringBuilder("Element ID\tPhần tử\tSystem Type / IFC\tSystem Name\tZ IFC (mm)\tNguồn dữ liệu\tIFC GUID");
