...
namespace IFCInfo
{
    ...
    public sealed class IFCInfoWindow : Window
    {
        ...
        public IFCInfoWindow()
        {
            ...
            Width = 1100; Height = 760; MinWidth = 540; MinHeight = 440;
            MaxWidth = SystemParameters.WorkArea.Width; MaxHeight = SystemParameters.WorkArea.Height;
            WindowStartupLocation = WindowStartupLocation.CenterOwner;
            ShowInTaskbar = false;
            FontFamily = new FontFamily("Segoe UI"); FontSize = 14;
            Background = Brush("#F3F6FA"); Foreground = Brush("#172B45");
            var root = new DockPanel { Background = Background }; Content = root;
            var header = new StackPanel { Margin = new Thickness(28, 24, 28, 20) };
            var heading = Text("Chọn link và Category", 26, "#172B45");
            heading.FontWeight = FontWeights.SemiBold;
            var subtitle = Text("Bước 1 · Chọn nguồn để tiếp tục", 14, "#60738A");
            header.Children.Add(heading); header.Children.Add(subtitle);
            DockPanel.SetDock(header, Dock.Top); root.Children.Add(header);
            var footer = new StackPanel { Margin = new Thickness(28, 14, 28, 20) };
            DockPanel.SetDock(footer, Dock.Bottom); root.Children.Add(footer);
            feedback = Text("Chọn IFC link và Category.", 13, "#60738A"); footer.Children.Add(feedback);
            ...
            var body = new StackPanel { Margin = new Thickness(28, 8, 28, 28) };
            var card = new StackPanel { Margin = new Thickness(24) };
            body.Children.Add(new Border { Child = card, Background = Brushes.White, CornerRadius = new CornerRadius(10),
                BorderBrush = Brush("#DFE6EE"), BorderThickness = new Thickness(1) });
            card.Children.Add(Text("IFC link", 14, "#172B45"));
            var linkBox = new ComboBox { MinHeight = 40, Margin = new Thickness(0, 8, 0, 24) }; card.Children.Add(linkBox);
            card.Children.Add(Text("Category", 14, "#172B45"));
            var categoryBox = new ComboBox { MinHeight = 40, Margin = new Thickness(0, 8, 0, 8), IsEnabled = false }; card.Children.Add(categoryBox);
