            ...
            ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                new System.Windows.Interop.WindowInteropHelper(dialog).Owner =
                    commandData.Application.MainWindowHandle;
                ConfigureCategories(dialog, linkedDoc, ifcPath);
